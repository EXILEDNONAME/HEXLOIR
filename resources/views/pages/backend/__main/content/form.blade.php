<div class="kt-form-item">
    <div class="flex flex-col lg:flex-row items-start gap-3">
        <span class="kt-form-label w-52 pt-2"> Id Tag </span>
        <div class="kt-form-control flex-1 w-full">
            {{ Html::text('id_tag', (isset($data->id_tag) ? $data->id_tag : ''))->class(['kt-input w-full']) }}
        </div>
    </div>
</div><div class="kt-form-item">
    <div class="flex flex-col lg:flex-row items-start gap-3">
        <span class="kt-form-label w-52 pt-2"> Id Category </span>
        <div class="kt-form-control flex-1 w-full">
            {{ Html::text('id_category', (isset($data->id_category) ? $data->id_category : ''))->class(['kt-input w-full']) }}
        </div>
    </div>
</div><div class="kt-form-item">
    <div class="flex flex-col lg:flex-row items-start gap-3">
