...
<!-- <div class="kt-form-item">
    <div class="flex flex-col lg:flex-row items-start gap-3">
        <span class="kt-form-label w-52 pt-2"> Tags </span>
        <div class="kt-form-control flex-1 w-full">
            {{ Html::text('tags', (isset($data->tags) ? $data->tags : ''))->class(['kt-input w-full']) }}
        </div>
    </div>
</div>
<div class="kt-form-item">
    <div class="flex flex-col lg:flex-row items-start gap-3">
        <span class="kt-form-label w-52 pt-2"> Categories </span>
        <div class="kt-form-control flex-1 w-full">
            {{ Html::text('categories', (isset($data->categories) ? $data->categories : ''))->class(['kt-input w-full']) }}
        </div>
    </div>
</div> -->
<div class="kt-form-item">
