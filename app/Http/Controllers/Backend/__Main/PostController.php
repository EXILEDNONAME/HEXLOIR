...
use App\Http\Requests\Backend\__Main\Post\StoreRequest;
use App\Http\Requests\Backend\__Main\Post\UpdateRequest;
...
class PostController extends Controller implements HasMiddleware 
{
    ...
    {
        $this->model            = 'App\Models\Backend\__Main\Post';
        $this->path             = 'pages.backend.__main.post.';
        $this->url              = '/dashboard/posts';
        $this->sort             = '1, desc';
        $this->status           = 'default';
