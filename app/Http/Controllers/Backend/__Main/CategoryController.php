...
use App\Http\Requests\Backend\__Main\Category\StoreRequest;
use App\Http\Requests\Backend\__Main\Category\UpdateRequest;
...
class CategoryController extends Controller implements HasMiddleware 
{
    ...
    {
        $this->model            = 'App\Models\Backend\__Main\Category';
        $this->path             = 'pages.backend.__main.category.';
        $this->url              = '/dashboard/categories';
        $this->sort             = '1, desc';
        $this->status           = 'default';
