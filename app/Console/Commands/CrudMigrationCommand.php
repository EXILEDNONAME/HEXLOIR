...
class CrudMigrationCommand extends GeneratorCommand
{
  ...
  */
  protected function getPath($name)
  {
    ...
    if ($this->option('view-path')) {
      $viewpath = '_' . $this->option('view-path');
    } else {
      $viewpath = "";
    }
  ...
  */
  ...
  $schemaUp =
  "Schema::create('main" . $viewpath . "_" . $tableName . "', function (Blueprint \$table) {
      ...
      $schemaDown = "Schema::dropIfExists('main_" . $viewpath . "_" . $tableName . "');";
